...
public class VeterinarioControllerTest {
    ...
    public void VeterinarioController_agregarVeterinario_Veterinario() throws Exception{
        ...
        //Esto esta dando error porque el .add es void y no retorna nada
    ...
    public void VeterinarioController_showAllVets_ListVeterinario() throws Exception{
        ...
        when(veterinarioService.SearchAll()).thenReturn(
            List.of(
                new Veterinario(
                    "1234567890",
                    "Juan1",
        ...
        ResultActions response = mockMvc.perform(get("/veterinario/all"));
