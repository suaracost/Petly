...
public class Databaseinit implements ApplicationRunner{
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        cliente = new Cliente("1000000001", "Alejandro", "Suarez", "alejandroesuareza@javeriana.edu.co", "12345671");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000002", "Hermann", "Hernandez", "hd.hernandez@javeriana.edu.co", "12345672");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000003", "Nicolas", "Rincon", "ni.rincon@javeriana.edu.co", "12345673");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000004", "Luis", "Ramirez", "luis@gmail.com", "12345674");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000005", "Ana", "Lopez", "ana@gmail.com", "12345675");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000006", "Jose", "Gonzalez", "jose@gmail.com", "12345676");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000007", "Laura", "Martinez", "laura@gmail.com", "12345677");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000008", "Carlos", "Hernandez", "carlos@gmail.com", "12345678");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000009", "Sofia", "Diaz", "sofia@gmail.com", "12345679");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000010", "Diego", "Torres", "diego@gmail.com", "12345680");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000011", "Paula", "Gomez", "paula@gmail.com", "12345681");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000012", "Alejandro", "Alvarez", "alejandro@gmail.com", "12345682");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000013", "Elena", "Fernandez", "elena@gmail.com", "12345683");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000014", "Miguel", "Castro", "miguel@gmail.com", "12345684");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000015", "Carmen", "Rojas", "carmen@gmail.com", "12345685");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000016", "Fernando", "Ortega", "fernando@gmail.com", "12345686");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000017", "Gabriela", "Vargas", "gabriela@gmail.com", "12345687");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000018", "Javier", "Reyes", "javier@gmail.com", "12345688");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000019", "Rosa", "Molina", "rosa@gmail.com", "12345689");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000020", "Pablo", "Navarro", "pablo@gmail.com", "12345690");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000021", "Isabel", "Santos", "isabel@gmail.com", "12345691");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000022", "Andres", "Cruz", "andres@gmail.com", "12345692");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000023", "Lucia", "Iglesias", "lucia@gmail.com", "12345693");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000024", "Daniel", "Fuentes", "daniel@gmail.com", "12345694");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000025", "Eva", "Herrera", "eva@gmail.com", "12345695");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000026", "Mario", "Aguilar", "mario@gmail.com", "12345696");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000027", "Raquel", "Lorenzo", "raquel@gmail.com", "12345697");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000028", "Alberto", "Gimenez", "alberto@gmail.com", "12345698");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000029", "Natalia", "Jimenez", "natalia@gmail.com", "12345699");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000030", "Antonio", "Mendez", "antonio@gmail.com", "12345700");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000031", "Sara", "Ruiz", "sara@gmail.com", "12345701");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000032", "Roberto", "Silva", "roberto@gmail.com", "12345702");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000033", "Ines", "Blanco", "ines@gmail.com", "12345703");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000034", "Gloria", "Gomez", "gloria@gmail.com", "12345704");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000035", "Victor", "Leon", "victor@gmail.com", "12345705");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000036", "Monica", "Navarro", "monica@gmail.com", "12345706");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000037", "Hugo", "Moreno", "hugo@gmail.com", "12345707");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000038", "Silvia", "Perez", "silvia@gmail.com", "12345708");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000039", "Ruben", "Castillo", "ruben@gmail.com", "12345709");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000040", "Marta", "Gutierrez", "marta@gmail.com", "12345710");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000041", "Raul", "Diaz", "raul@gmail.com", "12345711");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000042", "Clara", "Sanchez", "clara@gmail.com", "12345712");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000043", "Lorenzo", "Fernandez", "lorenzo@gmail.com", "12345713");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000044", "Alicia", "Morales", "alicia@gmail.com", "12345714");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000045", "Cristian", "Ortega", "cristian@gmail.com", "12345715");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000046", "Lidia", "Gonzalez", "lidia@gmail.com", "12345716");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000047", "Diego", "Martinez", "diego2@gmail.com", "12345717");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000048", "Sandra", "Hernandez", "sandra@gmail.com", "12345718");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000049", "Francisco", "Alvarez", "francisco@gmail.com", "12345719");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        cliente = new Cliente("1000000050", "Elena", "Santos", "elena2@gmail.com", "12345720");
        userEntity = ClientToUser(cliente);
        cliente.setUser(userEntity);
        clienteRepository.save(cliente);
        ...
        //Creacion de veterinarios y el admin con el uso del patron Builder
